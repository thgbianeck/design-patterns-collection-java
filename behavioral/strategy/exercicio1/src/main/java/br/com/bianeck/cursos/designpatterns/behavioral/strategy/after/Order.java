...
public class Order {
    ...
    public void applyDiscount() {
        if(this.subtotal > 0 && this.customerType != null){
            this.customerType.getDiscount().applyDiscount(this);
        }
    }
    ...
    public void calculateTax() {
        double taxRate = 0;
        if (this.shippingAddress.getCountry().equals("USA")) {
            taxRate = 0.07;
        } else if (this.shippingAddress.getCountry().equals("Canada")) {
            taxRate = 0.13;
        }
    ...
    public void calculateShipping() {
        this.shippingCost = this.shippingMethod.getShippingCost();
    }
